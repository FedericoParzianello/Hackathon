...
const navItems: NavItem[] = [
  { label: "Companies", icon: BuildingIcon, href: "/", active: true },
          ...
          if (item.active && item.href) {
            return (
              <Link
                key={item.label}
                href={item.href}
                className="flex items-center gap-3 rounded-lg bg-orange-500/10 px-2.5 py-2 text-sm font-medium text-orange-400 ring-1 ring-inset ring-orange-500/20 md:px-3"
              >
